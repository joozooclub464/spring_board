...
//검색의 기준, 화면을 구성할 기준, pageMaker에게 게시글 목록을 띄우게 시킬 떄 건네주는 정보들
@Getter
@Setter
@ToString
public class Criteria {
	...
	//생성자 직접 선언
	public Criteria() {
		//기본생성자. ==> 아무것도 없는 기본 설정으로 페이지를 띄워라
		
		//this() : 이 클래스의 생성자
		this(1,10); //현재 클래스의 생성자
	}
	...
	public String getListLink() {
		//?pagenum=3&amount=10 과 같으 형식의 문자열을 만드는 코드
	...
	public String[] getTypeArr() {
		...
		return type == null?new String[] {} : type.split(""); //3칸짜리 배열을 만들어서 반환	 
	}
